...
with open("main.csv", "w", newline='') as file:
    ...
    while 1:
        ...
        circles = cv2.HoughCircles(img_blur, cv2.HOUGH_GRADIENT, 0.1, 400, param1=600, param2=10, minRadius=76, maxRadius=84)
        if circles is not None:
            ...
            for i in circles[0, :]:
                ...
                if k==orn:
                    ...
                    print("_______\n",eye_x_p,eye_y_p,"\n_______")
                    spamwriter.writerow([eye_x_p*8,eye_y_p*5])
                    pygame.draw.circle(screen, (0,0,255), (eye_x_p*8, eye_y_p*5), 20)  
                ...
                pygame.draw.circle(screen, (255,0,0), ((i[0]-145)*8, (i[1]-145)*6), 20)  
                #pygame.draw.circle(screen, (0,255,255), ((i[0]-145)*7, (i[1]-145)*6), 20)  
                cv2.putText(image, str(i[0]*4) , (200,30), cv2.FONT_HERSHEY_SIMPLEX,0.5, (155, 255, 0), 2)
                cv2.putText(image, str(i[1]*6) , (200,50), cv2.FONT_HERSHEY_SIMPLEX,0.5, (155, 255, 0), 2)
